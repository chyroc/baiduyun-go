...
func (r *Client) requestJSON(method, uri string, req interface{}, resp interface{}) error {
	return r.request("json", method, uri, req, resp)
}

func (r *Client) requestURLEncode(method, uri string, req interface{}, resp interface{}) error {
	return r.request("url-encode", method, uri, req, resp)
}

func (r *Client) requestForm(method, uri string, req interface{}, resp interface{}) error {
	return r.request("form", method, uri, req, resp)
}

func (r *Client) request(requestType string, method, uri string, req interface{}, resp interface{}) error {
	reqString := debugJSON(req)
	if len(reqString) < 1024 {
		r.info("[xyun] %s#%s start\n", method, uri)
	} else {
		r.info("[xyun] %s#%s start, req=<too-long>\n", method, uri)
	}
...
func (r *Client) getAuthToken() (string, error) {
...
func (r *Client) refreshAuthToken() error {
	if r.accessToken != "" {
		return nil
	}
